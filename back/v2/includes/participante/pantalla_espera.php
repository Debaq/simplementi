<?php
// Registrar al participante en la sesión si aún no está registrado
...
// Si el participante no está registrado, añadirlo al array de participantes
if (!$participanteRegistrado) {
    $session_data['participantes'][] = [
        'id' => $participante_id,
