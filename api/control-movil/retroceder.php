<?php
/**
 * API: Retroceder Slide (Control Móvil)
 *
 * Retrocede al slide/pregunta anterior en la presentación.
...
if ($usesPdfSequence) {
    ...
    // Retroceder (no puede ser menor que 0)
    $newQuestion = max($currentQuestion - 1, 0);
...
// Retornar éxito
returnSuccess([
    'message' => 'Retrocedido correctamente',
